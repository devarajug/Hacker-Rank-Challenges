...
select city, length(city) as clength from station order by clength asc, city limit 1;
select city, length(city) as clength from station order by clength desc, city limit 1;